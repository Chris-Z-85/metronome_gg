...
const BpmPicker: React.FC<BpmPickerProps> = ({ bpm, setBpm, min = 30, max = 300 }) => {
  ...
  return (
    <div className="flex flex-col items-center select-none w-full max-w-xs sm:max-w-md md:max-w-lg h-64 sm:h-80 md:h-96">
            ...
            <div
              ...
              className={
                n === bpm
                  ...
                  : 'text-4xl md:text-5xl text-gray-400 opacity-50'
              }
              style={{
